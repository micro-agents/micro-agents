...
/**
 * The MessageCommunicator interface is implemented by any asynchronously
 * interacting agent (see @link AbstractCommunicator).
 * 
...
public interface MessageCommunicator {
	...
	public abstract void serveMessage(Message message);
