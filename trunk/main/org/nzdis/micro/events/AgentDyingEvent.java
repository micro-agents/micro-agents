...
/**
 * Represents an AgentDying event. This event is risen by the agent to
 * all interested parties just before the agent switches to the DEAD state. 
 * 
 *<br><br>
 * AgentDyingEvent.java<br>
 ...
 */
public class AgentDyingEvent extends Event {

  public AgentDyingEvent(String agent){
    super(agent);
  }
