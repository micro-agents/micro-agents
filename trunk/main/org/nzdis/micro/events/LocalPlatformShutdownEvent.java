...
/**
 * Represents a LocalPlatformShutdownEvent. It is raised when the local 
 ...
 */
public class LocalPlatformShutdownEvent extends Event {

	public LocalPlatformShutdownEvent(String agent) {
		super(agent);
	}
}
